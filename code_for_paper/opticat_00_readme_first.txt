This is a cleaned-up version of a series of scripts implementing the main
analyses presented in the paper:

Dimigen (2019). "Optimizing the ICA-based removal of ocular EEG artifacts from free viewing experiments" 
as published in "NeuroImage" (https://doi.org/10.1016/j.neuroimage.2019.116117)
...
To keep the pipeline readable, scripts for many of the supplementary analyses (more overweighting proportion, other saccade directions, visualization of filter characteristics, control analysis with steeper filter etc.) as well as scripts for some of the 
...
The simpe rmANOVA stats conducted in R require the "EZ" package.
...
I hope the code is helpful for researchers planning similar comparisons. I cannot share the raw EEG of both experiments at the moment but hope this will be possible in the future.
